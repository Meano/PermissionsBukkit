...
public final class PermissionInfo {
	...
	/**
	 * Gets a map of non-world-specific permission nodes to boolean values
	 * that this group/player defines.
	 *
	...
	/**
	 * Gets a map of world-specific permission nodes to boolean values that
